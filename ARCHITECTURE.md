...
Unlike guardrails (which constrain the agent's _actions_), checkpoints evaluate
the agent's _outputs_ and decide whether the run may proceed. A failed checkpoint
