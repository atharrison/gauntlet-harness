...
create policy "authenticated can read review_history"
  on review_history for select to authenticated using (true);

create policy "authenticated can read review_checkpoints"
  on review_checkpoints for select to authenticated using (true);
