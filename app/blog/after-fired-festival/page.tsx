...
export default function BlogPage() {
  return (
    <article className="mx-auto max-w-2xl py-12">
      ...
      {/* Intro + hero image side by side */}
      <div className="my-10 grid grid-cols-1 gap-8 sm:grid-cols-2 sm:items-start">
        ...
        <div className="overflow-hidden rounded-xl">
          <img
            src="/fired-festival-badge.png"
            alt="Andrew Harrison's Fired Festival Challenger badge resting against the Mac Mini prize box"
